...
def test(inp1):
    ...
    a = z3.RotateRight(-r + 0xC28F3F183BA05D, 0x34)
    r = mul(0x70717B53945B0533, a - -0x301D4459AB90D946)

    a = z3.RotateRight((r + 2) ^ -0x7C89CAFD210BEEF2, 0x22)
    r = mul(-0xE76D6D13715FBB9, z3.RotateLeft(a - 0x28EEAAF50204F377, 0x15))
    ...
    r = mul(
        -0x753136FAA69CB887,
        z3.RotateRight((r - -0x635F86A96045C266) ^ 0xA91EE3D67D08DF61, 0x13) - 1,
    )

    # Last step
    r = z3.RotateLeft(
        z3.RotateRight(-(z3.RotateRight(r, 0x11) - 1) - 0x2EA56B0EBE823585, 5)
        + 0x7FCC3EACE4EBA8D1,
        0x3E,
    )
                ...
                z3.RotateRight(
                    (
                        (
                            0x3896EB4AA778987A
                            - (
                                ((-(r) - -0x4C5698B156858997) ^ 0x972878F59896CB1C)
                                - 0x44684873B593128A
                            )
                        )
                        ^ 0x483429977C450318
